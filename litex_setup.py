...
git_repos = {
    ...
    "pythondata-cpu-cva6":         GitRepo(url="https://github.com/sergachev/", clone="recursive", branch="fix/settings"),
    ...
    "pythondata-cpu-naxriscv":     GitRepo(url="https://github.com/litex-hub/", sha1=0x8b808becb503),
