...
module InterruptController( // @[:@769.2]
  ...
  output        io_irq_writerDone, // @[:@772.4]
  input         io_readBusy, // @[:@772.4]
  input         io_writeBusy, // @[:@772.4]
  input  [31:0] io_imr_dataOut, // @[:@772.4]
  input         io_imr_dataWrite, // @[:@772.4]
  output [31:0] io_imr_dataIn, // @[:@772.4]
  input  [31:0] io_isr_dataOut, // @[:@772.4]
  input         io_isr_dataWrite, // @[:@772.4]
  output [31:0] io_isr_dataIn // @[:@772.4]
);
  ...
  reg [31:0] _RAND_5;
  wire  _T_59; // @[InterruptController.scala 50:35:@793.4]
  wire  _T_60; // @[InterruptController.scala 50:32:@794.4]
  wire [31:0] mask; // @[:@781.4 :@782.4]
  wire  _T_61; // @[InterruptController.scala 50:53:@795.4]
  wire  _T_62; // @[InterruptController.scala 50:46:@796.4]
  wire  _T_64; // @[InterruptController.scala 51:33:@798.4]
  wire  _T_65; // @[InterruptController.scala 51:30:@799.4]
  wire  _T_66; // @[InterruptController.scala 51:50:@800.4]
