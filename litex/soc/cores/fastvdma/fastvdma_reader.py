...
class FastVDMAReader(Module):
    def __init__(self, platform, data_width=32, adr_width=30):
        # Add verilog file with generated netlist for FastVDMA -------------------------------------
        platform.add_sources(os.path.abspath(os.path.dirname(__file__)), "fastvdma_reader.v")
        ...
        self.axi_m = AXIStreamInterface()
        self.axi_m_tuser = Signal()
        ...
        self.specials += Instance("fastvdma_reader",
            ...
            o_io_write_tuser = self.axi_m_tuser,
