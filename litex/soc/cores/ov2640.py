...
class OV2640(Module, AutoCSR):
    def __init__(self, pads, mode="single_frame", delay_pclk=0):
        ...
        self.specials += AsyncResetSynchronizer(self.cd_pclk, ResetSignal())
        ...
        # FSM
        self.submodules.fsm = fsm = ClockDomainsRenamer("pclk")(FSM(reset_state="WAIT_START_VSYNC"))
        ...
        fsm.act("CAPTURE",
            ...
            If (inner_valid,
                ...
                If(~counter & 1, #if counter % 2 == 0:
                    ...
                    NextValue(pixel_rgb565, (last_data << 8) | data[3]),
