...
static void write_inc_dqs_bitslip(int module) {
	/* Increment bitslip */
#ifdef SDRAM_PHY_SUBCHANNELS
	if (module < SDRAM_PHY_MODULES/2)
...
static void write_rst_dqs_bitslip(int module) {
	/* Increment bitslip */
#ifdef SDRAM_PHY_SUBCHANNELS
	if (module < SDRAM_PHY_MODULES/2)
...
static void cs_inc_delay(int channel) {
	/* Increment CS delay */
#ifdef SDRAM_PHY_SUBCHANNELS
	if (channel)
...
static void cs_rst_delay(int channel) {
	/* Reset CS delay */
#ifdef SDRAM_PHY_SUBCHANNELS
	if (channel)
...
static void ca_inc_delay(int channel) {
	/* Increment CA delay */
#ifdef SDRAM_PHY_SUBCHANNELS
	if (channel)
...
static void ca_rst_delay(int channel) {
	/* Reset CA delay */
#ifdef SDRAM_PHY_SUBCHANNELS
	if (channel)
...
static void par_inc_delay(int channel) {
	/* Increment PAR delay */
#ifdef SDRAM_PHY_SUBCHANNELS
	if (channel)
...
static void par_rst_delay(int channel) {
	/* Reset PAR delay */
#ifdef SDRAM_PHY_SUBCHANNELS
	if (channel)
...
static void cs_ca_deselect(int channel, int ca_cs_line) {
#ifdef SDRAM_PHY_SUBCHANNELS
	if (channel)
