...
_io = [
    ...
    ("mux_sel", 0, Pins("A2"), IOStandard("LVCMOS33")),
    ("mux_sel", 1, Pins("A13"), IOStandard("LVCMOS33")),
    ("mux_sel", 2, Pins("A12"), IOStandard("LVCMOS33")),
    ("serial", 0,
    ...
    ("pmodspi", 0,
        ...
        Subsignal("mosi", Pins("B12")),
        Subsignal("miso", Pins("C11")),
        IOStandard("LVCMOS33"),
    ),
    ("i2c", 0,
    ...
    ("jtag", 0,
        Subsignal("tck", Pins("B15"), Misc("DOWN")),
        Subsignal("tms", Pins("B13")),
        Subsignal("tdo", Pins("C12")),
        Subsignal("tdi", Pins("B3")),
        IOStandard("LVCMOS33"),
    ),

    ("jtag_int", 0,
        Subsignal("tck", Pins("F8")),
