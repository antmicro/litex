...
_io = [
    ...
    ("eth", 0,
     ...
     Subsignal("dat_r",   Pins("SYN106 SYN107 SYN108 SYN109 SYN110 SYN111 SYN112 SYN113 SYN114 SYN115 SYN116 SYN117 SYN118 SYN119 SYN120 SYN121 SYN122 SYN123 SYN124 SYN125 SYN126 SYN127 SYN128 SYN129 SYN130 SYN131 SYN132 SYN133 SYN134 SYN135 SYN136 SYN137 ")),
     Subsignal("sel",   Pins("SYN64 SYN65 SYN66 SYN67 ")),
     Subsignal("cyc",   Pins("SYN68 ")),
     Subsignal("stb",   Pins("SYN69 ")),
     Subsignal("ack",   Pins("SYN138 ")),
     Subsignal("we",   Pins("SYN70 ")),
     Subsignal("cti",   Pins("SYN71 SYN72 SYN73 ")),
     Subsignal("bte",   Pins("SYN74 SYN75 ")),
     Subsignal("err",   Pins("SYN139 ")),
 ),
 ("synthio_in", 0,
 ...
 ("synthio_out", 0,
     Subsignal("out0",   Pins("SYN140 ")),
     Subsignal("out1",   Pins("SYN141 SYN142 ")),
     Subsignal("out2",   Pins("SYN143 SYN144 SYN145 ")),
     Subsignal("out3",   Pins("SYN146 SYN147 SYN148 SYN149 ")),
     Subsignal("out4",   Pins("SYN150 SYN151 SYN152 SYN153 SYN154 ")),
 ),
]
