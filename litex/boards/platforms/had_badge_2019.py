...
_io = [
    ...
    ("user_led", 6, Pins("K20"), IOStandard("LVCMOS33")),
    ("user_led", 7, Pins("K19"), IOStandard("LVCMOS33")),
    ("user_led", 8, Pins("B20"), IOStandard("LVCMOS33")),
    ("user_led", 9, Pins("B19"), IOStandard("LVCMOS33")),
    ("user_led", 10, Pins("P19"), IOStandard("LVCMOS33")),
    ("user_led", 11, Pins("L18"), IOStandard("LVCMOS33")),
    ("user_led", 12, Pins("K18"), IOStandard("LVCMOS33")),
    ...
    ("serial", 0,
        ...
        Subsignal("rx", Pins("U2"), Misc("PULLMODE=UP")),
        IOStandard("LVCMOS33"),
    ),
    ...
    ("gdpi", 0,
        ...
        IOStandard("LVCMOS33"), Misc("DRIVE=4"),
    ),
    ...
    ("spipsram_a", 0,
        Subsignal("cs_n", Pins("D20")),
        Subsignal("clk", Pins("E20")),
        Subsignal("mosi", Pins("E19"), Misc("PULLMODE=UP")),
        Subsignal("miso", Pins("D19"), Misc("PULLMODE=UP")),
        IOStandard("LVCMOS33"),
    ),
    ...
    ("spipsram_b", 0,
        Subsignal("cs_n", Pins("F20")),
        Subsignal("clk", Pins("J19")),
        Subsignal("mosi", Pins("J20"), Misc("PULLMODE=UP")),
        Subsignal("miso", Pins("G19"), Misc("PULLMODE=UP")),
        IOStandard("LVCMOS33"),
    ),
